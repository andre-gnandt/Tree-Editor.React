...
const TreeNode = (props, css) => {
    ...
    if(props == null || props.props == null || !('id' in props.props)) return (<></>);   
        ...
        return(
            <>
                <div onLoad = {(event) => {}} id = {props.props.id} className={props.props.id} style = {{position:'absolute', right: props.css.right, top: props.css.top, left: props.css.left, display: 'table', border: '1px solid red', height: '80px', width: '80px'}}>
